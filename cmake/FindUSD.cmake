...
file(GLOB files "${USD_LIBRARY_DIR}/${USD_LIB_PREFIX}*${USD_LIB_SUFFIX}")
set(USD_LIBRARIES ${files})

# Get the boost version from the one built with USD
if(USD_INCLUDE_DIR)
    file(GLOB _USD_VERSION_HPP_FILE "${USD_INCLUDE_DIR}/boost/version.hpp")
...
file(GLOB files "${USD_LIBRARY_DIR}/${CMAKE_SHARED_LIBRARY_PREFIX}boost*${USD_LIB_SUFFIX}")
set(USD_BOOST_LIBRARIES ${files})
